...
export default function AccessibilityModal({ onClose }: { onClose: () => void }) {
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md flex flex-col overflow-hidden animate-in fade-in zoom-in duration-200">
        <div className="flex justify-between items-center px-6 py-4 border-b border-slate-100 bg-slate-50">
          <div className="flex items-center gap-3">
            ...
            <h3 className="font-bold text-slate-900 text-lg tracking-tight">Accessibility Settings</h3>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-6 bg-white">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-slate-500">Increases color contrast for better readability.</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-slate-500">Disables UI animations and transitions.</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input 
                type="checkbox" 
