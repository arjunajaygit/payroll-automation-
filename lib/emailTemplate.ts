  ...
  return `
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #ffffff; border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden; color: #334155;">
      <div style="background-color: #0f172a; padding: 32px 24px; text-align: center;">
        ...
        <p style="color: #94a3b8; margin: 8px 0 0 0; font-size: 14px;">Salary Document &bull; ${month} ${year}</p>
      </div>
      <div style="padding: 32px 24px;">
        <p style="font-size: 16px; margin-top: 0; color: #0f172a;">Dear <strong>${employeeName}</strong>,</p>
        <p style="font-size: 15px; line-height: 1.6; color: #475569;">Your compensation document for the period of <strong>${month} ${year}</strong> has been successfully processed and is attached to this email.</p>
