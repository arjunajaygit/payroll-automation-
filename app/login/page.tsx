...
export default function Login() {
  const [email, setEmail] = useState("admin@payrollpro.com");
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-white/10 backdrop-blur-xl p-8 rounded-3xl shadow-2xl border border-white/20">
          <div className="text-center mb-8">
            ...
            <p className="text-blue-200">Sign in to manage your payroll</p>
          </div>
          
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-3 text-sm text-blue-200 text-center mb-4">
              <span className="font-semibold text-blue-300">Demo Credentials:</span> admin@payrollpro.com / admin123
            </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-blue-200">
              ...
              <Link href="/signup" className="font-medium text-white hover:text-blue-300 transition underline decoration-blue-400/50 underline-offset-4">
                Create one now
              </Link>
            </p>
          </div>
